...
#
#if ! /opt/puppetlabs/puppet/bin/gem list deep_merge; then
#    /opt/puppetlabs/puppet/bin/gem install deep_merge --no-ri --no-rdoc
#fi
#
#if ! /opt/puppetlabs/puppet/bin/gem list activesupport; then
#    /opt/puppetlabs/puppet/bin/gem install activesupport --no-ri --no-rdoc
#fi
#
#if ! /opt/puppetlabs/puppet/bin/gem list vine; then
